  ...
  return(
    <div>
      <p>
          ...
          <hr></hr>
          <div class = "box-header"> WHAT IS SYMPTOMS OF COVID 19?</div>
            <div class="box-body"><iframe width="560" height="315" src="https://www.youtube.com/embed/cm8TCgDzs-I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
</div>
